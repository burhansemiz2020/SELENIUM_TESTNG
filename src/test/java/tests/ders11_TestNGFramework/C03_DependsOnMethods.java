...
public class C03_DependsOnMethods {
    ...
    //1. amazon anasayfaya gidip, amazona gittigimizi test edelim
    //2. amazon anasayfada arama kutusunun enable oldugunu test edin
    //3. arama kutusuna Nutella yazip aratin, sonuclarin Nutella oldugunu Test edin
     /*
        Notlar
